...
const int SPL_COST_TRFSHEEP = 1;
const int SPL_COST_TRFSCAVENGER = 1;
const int SPL_COST_TRFGIANTRAT = 1;
const int SPL_COST_TRFGIANTBUG = 1;
const int SPL_COST_TRFWOLF = 2;
const int SPL_COST_TRFWARAN = 2;
const int SPL_COST_TRFSNAPPER = 2;
const int SPL_COST_TRFWARG = 3;
const int SPL_COST_TRFFIREWARAN = 3;
const int SPL_COST_TRFLURKER = 1;
const int SPL_COST_TRFSHADOWBEAST = 3;
const int SPL_COST_TRFDRAGONSNAPPER = 3;
