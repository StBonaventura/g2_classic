...
const int SPL_COST_PALLIGHTHEAL = 1;
const int SPL_COST_PALMEDIUMHEAL = 2;
const int SPL_COST_PALFULLHEAL = 3;
const int SPL_COST_LIGHTHEAL = 1;
const int SPL_COST_MEDIUMHEAL = 2;
const int SPL_COST_FULLHEAL = 3;
