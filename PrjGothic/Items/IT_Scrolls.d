...
instance ITSC_WINDFIST(C_ITEM)
{
	...
	spell = SPL_WINDFIST;
	cond_atr[2] = ATR_MANA_MAX;
	cond_value[2] = SPL_COST_WINDFIST / 5;
	description = NAME_SPL_WINDFIST;
	text[0] = NAME_MAGESCROLL;
	text[1] = NAME_MANAKOSTENMIN;
	count[1] = SPL_COST_WINDFIST / 5;
...
instance ITSC_CHARGEFIREBALL(C_ITEM)
{
	...
	cond_atr[2] = ATR_MANA_MAX;
	cond_value[2] = SPL_COST_CHARGEFIREBALL / 5;
...
instance ITSC_THUNDERBALL(C_ITEM)
{
	...
	spell = SPL_CHARGEZAP;
	cond_atr[2] = ATR_MANA_MAX;
	cond_value[2] = SPL_COST_CHARGEZAP / 5;
	description = NAME_SPL_CHARGEZAP;
	text[0] = NAME_MAGESCROLL;
	text[1] = NAME_MANAKOSTENMIN;
	count[1] = SPL_COST_CHARGEZAP / 5;
	text[2] = NAME_MANAKOSTENMAX;
...
instance ITSC_PYROKINESIS(C_ITEM)
{
	...
	cond_atr[2] = ATR_MANA_MAX;
	cond_value[2] = SPL_COST_FIRESTORM / 5;
